...
public class JavaSample {
  ...
  public static final String USERNAME = "smaretick3";
...
private static int chromedriver;
  ...
  public static void main(String[] args) throws Exception {
    ...
    driver.findElement(By.xpath("html/body/div/ui-view/div/div/div/div[1]/form/div[1]/input")).sendKeys("dshaw@ptisecurity.com"); //USERNAME
    driver.findElement(By.xpath("html/body/div/ui-view/div/div/div/div[1]/form/div[2]/input")).clear();
    driver.findElement(By.xpath("html/body/div/ui-view/div/div/div/div[1]/form/div[2]/input")).sendKeys("t5LZwpvHQP");  //PASSWORD
